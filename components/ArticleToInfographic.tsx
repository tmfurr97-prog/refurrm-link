...
import { saveArticleLog } from '../services/firebase';
  ...
  const handleGenerate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (resultImage) {
          ...
          if (user) {
            let title = urlInput;
            try { title = new URL(urlInput).hostname; } catch(e) {}
            await saveArticleLog({
              title,
              url: urlInput,
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 mb-12">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-emerald-200 via-teal-200 to-slate-500 font-sans">
      ...
      {/* Input Section */}
      <div className="glass-panel rounded-3xl p-6 md:p-8 space-y-8 relative z-10">
