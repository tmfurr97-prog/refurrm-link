...
import { isClientAiEnabled } from './services/runtimeConfig';
...
const App: React.FC = () => {
  ...
  return (
      ...
      {isClientAiEnabled && !hasApiKey && <ApiKeyModal onKeySelected={() => setHasApiKey(true)} />}
